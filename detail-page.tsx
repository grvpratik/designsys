    ...
    >
      <div className="p-4 max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <IconButton as={Link} to="/discover" icon={<ArrowLeftIcon size={20} />} />
        ...
        <div className="flex flex-col items-start mb-6">
          ...
          <div className="text-xs text-gray-500 mt-1 w-full text-start break-all">{itemData.contractAddress}</div>
        ...
        <InfoCard>
          {activeTab === "onchain" && (
            <div className="space-y-2">
              ...
              <DataRow
                label="Contract"
                value={`${itemData.onchain.contractAddress.substring(0, 10)}...`}
          ...
          {activeTab === "social" && (
            <div className="space-y-2">
              <DataRow label="Twitter" value={itemData.social.twitter} valueClassName="text-green-500" />
              <DataRow label="Telegram" value={itemData.social.telegram} valueClassName="text-green-500" />
              <DataRow label="Discord" value={itemData.social.discord} valueClassName="text-green-500" />
              <DataRow label="Followers" value={itemData.social.followers} />
              <DataRow label="Sentiment" value={itemData.social.sentiment} valueClassName="text-green-500" />
            </div>
          )}
        </InfoCard>
      </div>
